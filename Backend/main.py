...
nuevo_pedido_conv = ConversationHandler(
    entry_points=[
        ...
        MessageHandler(Filters.regex(r'^Nuevo pedido        CallbackQueryHandler(nuevo_pedido_desde_cotizador, pattern=r"^cotizar_cust_(nuevo|recurrente)$"),
    ],
    states={
...
def main():
    ...
    dp.add_handler(MessageHandler(Filters.location, reference_assign_location_handler), group=1)`r`n
...
), nuevo_pedido),`r`n        CallbackQueryHandler(nuevo_pedido_desde_cotizador, pattern=r"^cotizar_cust_(nuevo|recurrente)$"),
    ],
    states={
        PEDIDO_SELECTOR_CLIENTE: [
            CallbackQueryHandler(pedido_selector_cliente_callback, pattern=r"^pedido_(cliente_recurrente|cliente_nuevo|repetir_ultimo|buscar_cliente|sel_cust_\d+)$")
