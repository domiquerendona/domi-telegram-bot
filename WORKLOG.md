...
| 2026-04-09 | codex | AGENTS.md, CLAUDE.md, WORKLOG.md, Backend/db.py, Backend/migrations/postgres_schema.sql, Backend/order_delivery.py, Backend/handlers/order.py, Backend/handlers/route.py, docs/proteccion_repartidor_confirmacion_pago_2026-03-19.md, tests/test_callback_routing.py, tests/test_courier_offer_visibility.py, tests/test_admin_special_order_addresses.py, tests/test_order_delivery_fees.py | Base requerida unificada en pedido aliado, pedido especial admin y ruta multi-parada: captura, persistencia, preview, filtro de elegibilidad y oferta al courier | COMPLETADO |
| 2026-04-09 | codex | WORKLOG.md, CLAUDE.md, docs/postgresql_first_migration_2026-04-09.md, docs/callback_governance_2026-03-12.md, Backend/order_delivery.py, Backend/main.py, Backend/handlers/admin_panel.py, Backend/handlers/customer_agenda.py, Backend/handlers/location_agenda.py, tests/test_order_delivery_fees.py | Fase 0 PostgreSQL-first + cierre de mejoras operativas pendientes (visibilidad courier, contadores admin, correccion directa desde agendas) | COMPLETADO |
| 2026-04-07 | claude | Backend/handlers/order.py, Backend/handlers/route.py, docs/roadmap_futuro.md, CLAUDE.md, docs/callback_governance_2026-03-12.md | feat: botones Editar en preview de pedido aliado, pedido admin y ruta + fix bugs 7 y 8 (tarifa admin y pickup ruta) — todos los flujos paralelos verificados | COMPLETADO |
