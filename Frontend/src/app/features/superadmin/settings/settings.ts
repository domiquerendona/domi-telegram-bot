              ...
              <div class="campo" *ngFor="let f of campos">
                ...
                <div class="input-wrap">
                  ...
                  <input
                    ...
                    min="0"
                    step="{{ f.tipo === 'km' ? '0.1' : '1' }}"
                  />
                  <span class="suffix" *ngIf="f.unit && f.unit !== '$'">{{ f.unit }}</span>
                </div>
              </div>
            </div>
...
export class SettingsComponent implements OnInit {
  ...
  campos: PricingField[] = [
    { key: 'pricing_precio_0_2km',            label: 'Precio tramo 1',        desc: 'Precio para 0-1.5 km',                            unit: '$',  tipo: 'money' },
    { key: 'pricing_precio_2_3km',            label: 'Precio tramo 2',        desc: 'Precio para >1.5-2.5 km',                         unit: '$',  tipo: 'money' },
    { key: 'pricing_tier1_max_km',            label: 'Limite tramo 1',        desc: 'Km maximos incluidos en el tramo 1',             unit: 'km', tipo: 'km'    },
    { key: 'pricing_tier2_max_km',            label: 'Limite tramo 2',        desc: 'Fin del tramo 2 y base de km extra',             unit: 'km', tipo: 'km'    },
    { key: 'pricing_km_extra_normal',         label: 'Km extra normal',       desc: 'Precio por km adicional antes del umbral largo', unit: '$',  tipo: 'money' },
    { key: 'pricing_umbral_km_largo',         label: 'Umbral km largo',       desc: 'A partir de este km aplica tarifa larga',        unit: 'km', tipo: 'km'    },
    { key: 'pricing_km_extra_largo',          label: 'Km extra largo',        desc: 'Precio por km adicional al superar el umbral',   unit: '$',  tipo: 'money' },
    { key: 'pricing_tarifa_parada_adicional', label: 'Parada adicional',      desc: 'Cargo por parada adicional en rutas',            unit: '$',  tipo: 'money' },
    { key: 'buy_free_threshold',              label: 'Productos gratis',      desc: 'Unidades sin recargo en compras',                unit: '',   tipo: 'count' },
